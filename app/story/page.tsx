    ...
    <>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-16 items-start">
          {/* Text */}
          <div>
            <p className="text-[#1c2b4b] text-xl leading-relaxed mb-8">
            ...
            <p className="text-[#1c2b4b] text-xl leading-relaxed mb-14">
            ...
            <blockquote className="border-l-2 border-[#b8924a] pl-8 mb-14">
              <p className="font-serif text-2xl md:text-3xl text-[#1c2b4b] italic leading-relaxed">
      ...
      <section className="bg-[#b8924a] py-16 px-6 text-center">
        <h2 className="font-serif text-3xl md:text-4xl text-[#1c2b4b] mb-4">
          Join Us in Sicily
        </h2>
